...
/**
 * Représente un utilisateur de l'application (visiteur, comptable, RH, directeur).
 * 
...
public class Utilisateur {
	 ...
	 * @param idRole            rôle associé
	 * @param nom               nom de famille
	 * @param prenom            prénom
	 * @param login             login de connexion
	 * @param mdp               mot de passe
	 * @param dateCreationMdp   date de création du mot de passe
	 * @param adresse           adresse postale
	 * @param cp                code postal
	 * @param ville             ville
	 * @param region            région
	 * @param telephoneFixe     numéro de téléphone fixe
	 * @param telephonePortable numéro de téléphone portable
