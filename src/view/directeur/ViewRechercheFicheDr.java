...
/**
 * Écran de recherche de visiteurs pour le directeur avec filtrage par ID, nom et région.
 *
 * @author Matthieu CAMPAGNA
 */
public class ViewRechercheFicheDr extends JFrame {
