...
/**
 * Écran de recherche de visiteurs pour consulter leur fiche (RH).
 *
 * @author Matthieu CAMPAGNA
 */
public class ViewRechercheFicheRh extends JFrame {
	...
	private void ouvrirFiche() {
		...
		if (ligne == -1) {
			...
			ViewFicheRh frame = new ViewFicheRh();
